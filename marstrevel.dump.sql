...
CREATE TABLE `coupon_firms` ( 
	...
	`requisites` VarChar( 255 ) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL, 
	`address` VarChar( 255 ) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL, 
	`description` VarChar( 350 ) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
	 PRIMARY KEY ( `id` )
 )
CHARACTER SET = utf8
COLLATE = utf8_general_ci
...
CREATE TABLE `prices_flights` ( 
	...
	`total_places` Int( 10 ) UNSIGNED NOT NULL, 
	`free_places` Int( 255 ) NOT NULL, 
...
-- Dump data of "cities" -----------------------------------
INSERT INTO `cities`(`id`,`name`,`active`,`images`) VALUES ( '1', 'Стамбул', '1', '/files/city/1/eb0830e9f70f64b1a2cf1b938768b89f.jpg' );
INSERT INTO `cities`(`id`,`name`,`active`,`images`) VALUES ( '2', 'Измир', '1', '/files/city/2/ded95f1157a7aa4238f8e496f217c986.jpg' );
INSERT INTO `cities`(`id`,`name`,`active`,`images`) VALUES ( '3', 'Анкара', '1', '/files/city/3/dba9290925a0037454383cedf0a6f5fd.jpg' );
INSERT INTO `cities`(`id`,`name`,`active`,`images`) VALUES ( '4', 'Анталья', '1', '/files/city/4/00af3221526b20388191b74931bf12af.jpg' );
-- ---------------------------------------------------------
...
INSERT INTO `coupon_firms`(`id`,`name`,`active`,`user_id`,`phone`,`contact`,`requisites`,`address`,`description`) VALUES ( '1', 'Первая тестовая', '1', '1', '566854', 'Вася', '<p><strong>контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-конт', 'Минск', '<p>контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-контент-кон' );
INSERT INTO `coupon_firms`(`id`,`name`,`active`,`user_id`,`phone`,`contact`,`requisites`,`address`,`description`) VALUES ( '2', 'Вторая тестовая', '1', '2', '', 'Z', '<p><br></p>', '', '<p><br></p>' );
-- ---------------------------------------------------------


-- Dump data of "coupons" ----------------------------------
INSERT INTO `coupons`(`id`,`code`,`firm_id`,`tour_id`,`active`,`user_id`) VALUES ( '108', 'dc9861974a4', '1', '55', '1', '1' );
INSERT INTO `coupons`(`id`,`code`,`firm_id`,`tour_id`,`active`,`user_id`) VALUES ( '109', '4ff3795cc73', '1', '55', '1', '1' );
INSERT INTO `coupons`(`id`,`code`,`firm_id`,`tour_id`,`active`,`user_id`) VALUES ( '110', 'b253ce8f8098', '1', '56', '1', '1' );
INSERT INTO `coupons`(`id`,`code`,`firm_id`,`tour_id`,`active`,`user_id`) VALUES ( '111', 'b7c2949bcc2c08', '1', '55', '1', '1' );
INSERT INTO `coupons`(`id`,`code`,`firm_id`,`tour_id`,`active`,`user_id`) VALUES ( '112', '85bf32cf3e3f15', '1', '56', '1', '1' );
INSERT INTO `coupons`(`id`,`code`,`firm_id`,`tour_id`,`active`,`user_id`) VALUES ( '113', '5bac1c6c6f49850', '1', '55', '1', '1' );
INSERT INTO `coupons`(`id`,`code`,`firm_id`,`tour_id`,`active`,`user_id`) VALUES ( '114', '6b75a27eb1ad9b', '1', '55', '1', '1' );
INSERT INTO `coupons`(`id`,`code`,`firm_id`,`tour_id`,`active`,`user_id`) VALUES ( '115', 'ecd7176f73a05', '1', '56', '1', '1' );
INSERT INTO `coupons`(`id`,`code`,`firm_id`,`tour_id`,`active`,`user_id`) VALUES ( '116', '63eaa00465b24', '1', '57', '1', '1' );
INSERT INTO `coupons`(`id`,`code`,`firm_id`,`tour_id`,`active`,`user_id`) VALUES ( '117', 'c4baf5b7357b', '2', '55', '1', '2' );
INSERT INTO `coupons`(`id`,`code`,`firm_id`,`tour_id`,`active`,`user_id`) VALUES ( '118', '5f22c2c622e9', '2', '57', '1', '2' );
-- ---------------------------------------------------------
...
-- Dump data of "orders" -----------------------------------
INSERT INTO `orders`(`id`,`fio`,`dob`,`validity`,`issuedby`,`email`,`phone`,`agreement`,`payment`,`number_order`,`surcharge`,`passport`,`tour_id`,`date`,`quantity_adults`,`quantity_children`,`cost`,`active`) VALUES ( '35', 'd', 'd', 'd', 'd', 'demod', 'dfdsd', '1', '2', '96bb23a3', '0', 'd', '55', '2015-08-27', '2', '0', '0', '1' );
-- ---------------------------------------------------------
...
-- Dump data of "prices_flights" ---------------------------
INSERT INTO `prices_flights`(`id`,`start_date`,`end_date`,`price`,`total_places`,`free_places`,`active`) VALUES ( '1', '2015-08-02', '2015-08-13', '30000', '10', '9', '1' );
INSERT INTO `prices_flights`(`id`,`start_date`,`end_date`,`price`,`total_places`,`free_places`,`active`) VALUES ( '2', '2015-08-21', '2015-08-31', '6000', '5', '2', '1' );
-- ---------------------------------------------------------


-- Dump data of "questions" --------------------------------
INSERT INTO `questions`(`id`,`name`,`email`,`phone`,`question`) VALUES ( '24', 'rrr', 'rrr', 'rrr', 'rrr' );
INSERT INTO `questions`(`id`,`name`,`email`,`phone`,`question`) VALUES ( '25', 'safasdf', 'adfsdf', 'dsfsdfwefsdfsd', 'fsdf' );
-- ---------------------------------------------------------
...
-- Dump data of "sight_excursion" --------------------------
INSERT INTO `sight_excursion`(`sight_id`,`excursion_id`) VALUES ( '1', '1' );
INSERT INTO `sight_excursion`(`sight_id`,`excursion_id`) VALUES ( '2', '1' );
INSERT INTO `sight_excursion`(`sight_id`,`excursion_id`) VALUES ( '1', '2' );
INSERT INTO `sight_excursion`(`sight_id`,`excursion_id`) VALUES ( '2', '2' );
-- ---------------------------------------------------------
...
Fantasy<br />
Land 2</p>
', '/files/slide/9/0732da8c48d87fd10af159e63a8caabe.jpg', '2', '0', '#' );
...
', 'Йо-хо-хо, и бутылка рома', 'a:4:{i:0;s:1:"1";i:1;s:1:"2";i:2;s:1:"3";i:3;s:1:"1";}', '1000' );
INSERT INTO `tours`(`id`,`name`,`active`,`content`,`url`,`md5_url`,`s_description`,`s_keywords`,`s_title`,`position`,`images`,`price`,`main_image`,`short_content`,`d1_name`,`d2_name`,`d3_name`,`d4_name`,`d5_name`,`d6_name`,`d7_name`,`d8_name`,`d1_content`,`d2_content`,`d3_content`,`d4_content`,`d5_content`,`d6_content`,`d7_content`,`d8_content`,`included`,`excluded`,`slogan`,`route`,`price_child`) VALUES ( '56', 'Тур «Наследие великих цивилизаций» 2', '1', '<p>8-дневный тур &laquo;Наследие великих цивилизаций&raquo;. Вы проведете несколько дней в Стамбуле, который по праву причисляют к мировым культурным столицам. Из Стамбула Ваш маршрут будет пролегать через воспетую Гомером Трою, античный Пергам, современный портовый город Кушадасы и далее через живописные Таврские горы в бурлящую энергией Анталию с ее фантастическим побережьем</p>
', 'tur-nasledie-velikih-tsivilizatsiy-2', 'd8f9612777464224ed0604b0a4dd1280', '', '', '', '2', '["\\/files\\/tour\\/56\\/23b6d657efaa67774b9b7208795cc4d9.jpg","\\/files\\/tour\\/56\\/aca00fce4685528813320ead2ab111ec.jpg"]', '50000', '/files/tour/56/60a5f63dda70a1ceaa6ad79789c3acbb.jpg', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'a:2:{i:0;s:1:"2";i:1;s:1:"3";}', '2000' );
INSERT INTO `tours`(`id`,`name`,`active`,`content`,`url`,`md5_url`,`s_description`,`s_keywords`,`s_title`,`position`,`images`,`price`,`main_image`,`short_content`,`d1_name`,`d2_name`,`d3_name`,`d4_name`,`d5_name`,`d6_name`,`d7_name`,`d8_name`,`d1_content`,`d2_content`,`d3_content`,`d4_content`,`d5_content`,`d6_content`,`d7_content`,`d8_content`,`included`,`excluded`,`slogan`,`route`,`price_child`) VALUES ( '57', 'Тур «Наследие великих цивилизаций» 3', '1', '<p>8-дневный тур &laquo;Наследие великих цивилизаций&raquo;. Вы проведете несколько дней в Стамбуле, который по праву причисляют к мировым культурным столицам. Из Стамбула Ваш маршрут будет пролегать через воспетую Гомером Трою, античный Пергам, современный портовый город Кушадасы и далее через живописные Таврские горы в бурлящую энергией Анталию с ее фантастическим побережьем</p>
', 'tur-nasledie-velikih-tsivilizatsiy-3', '6fb1e82e4cff9ef3e06da4e4194e509e', '', '', '', '3', '[]', '40000', '/files/tour/57/caa061bccc52d35ed6c24ddaf0031045.jpg', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'a:2:{i:0;s:1:"1";i:1;s:1:"4";}', '3000' );
INSERT INTO `tours`(`id`,`name`,`active`,`content`,`url`,`md5_url`,`s_description`,`s_keywords`,`s_title`,`position`,`images`,`price`,`main_image`,`short_content`,`d1_name`,`d2_name`,`d3_name`,`d4_name`,`d5_name`,`d6_name`,`d7_name`,`d8_name`,`d1_content`,`d2_content`,`d3_content`,`d4_content`,`d5_content`,`d6_content`,`d7_content`,`d8_content`,`included`,`excluded`,`slogan`,`route`,`price_child`) VALUES ( '58', 'Тур «Наследие великих цивилизаций» 4', '0', '', 'tur-nasledie-velikih-tsivilizatsiy-4', 'f9550c65bea203bced8666e6cc0f08b8', '', '', '', '0', '[]', '34', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'a:1:{i:0;N;}', '0' );
INSERT INTO `tours`(`id`,`name`,`active`,`content`,`url`,`md5_url`,`s_description`,`s_keywords`,`s_title`,`position`,`images`,`price`,`main_image`,`short_content`,`d1_name`,`d2_name`,`d3_name`,`d4_name`,`d5_name`,`d6_name`,`d7_name`,`d8_name`,`d1_content`,`d2_content`,`d3_content`,`d4_content`,`d5_content`,`d6_content`,`d7_content`,`d8_content`,`included`,`excluded`,`slogan`,`route`,`price_child`) VALUES ( '59', 'Тур «Наследие великих цивилизаций» 5', '0', '', 'tur-nasledie-velikih-tsivilizatsiy-5', 'a08667f24d26c36814249a33e6e500e7', '', '', '', '0', '[]', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'a:1:{i:0;N;}', '0' );
INSERT INTO `tours`(`id`,`name`,`active`,`content`,`url`,`md5_url`,`s_description`,`s_keywords`,`s_title`,`position`,`images`,`price`,`main_image`,`short_content`,`d1_name`,`d2_name`,`d3_name`,`d4_name`,`d5_name`,`d6_name`,`d7_name`,`d8_name`,`d1_content`,`d2_content`,`d3_content`,`d4_content`,`d5_content`,`d6_content`,`d7_content`,`d8_content`,`included`,`excluded`,`slogan`,`route`,`price_child`) VALUES ( '60', 'Тур «Наследие великих цивилизаций» 6', '0', '', 'tur-nasledie-velikih-tsivilizatsiy-6', 'f1b44a9f6d9a914e6252c28e142f3373', '', '', '', '0', '[]', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'a:1:{i:0;N;}', '0' );
INSERT INTO `tours`(`id`,`name`,`active`,`content`,`url`,`md5_url`,`s_description`,`s_keywords`,`s_title`,`position`,`images`,`price`,`main_image`,`short_content`,`d1_name`,`d2_name`,`d3_name`,`d4_name`,`d5_name`,`d6_name`,`d7_name`,`d8_name`,`d1_content`,`d2_content`,`d3_content`,`d4_content`,`d5_content`,`d6_content`,`d7_content`,`d8_content`,`included`,`excluded`,`slogan`,`route`,`price_child`) VALUES ( '61', 'Тур «Наследие великих цивилизаций» 7', '0', '', 'tur-nasledie-velikih-tsivilizatsiy-7', '7261e115afd13d1043f7f175d645887b', '', '', '', '0', '[]', '0', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'a:1:{i:0;N;}', '0' );
-- ---------------------------------------------------------
...
-- Dump data of "users" ------------------------------------
INSERT INTO `users`(`id`,`email`,`password`,`roles`,`name`,`logins`,`last_login`,`login_attempts`,`banned_to`,`ban_time`,`reset_password_code`,`created_at`,`updated_at`,`register_token`,`active`,`username`) VALUES ( '1', 'admin@ariol.by', '32c473f545fbbafd2c275b6ef518f2cccf14059b5ca6e1f00c2a7748528398b9', '1', 'zgolich', '313', '1440688175', '0', NULL, NULL, NULL, '1392567501', '1440688175', NULL, '1', 'd55b50f8ebd78188a0effa94ef101edb' );
INSERT INTO `users`(`id`,`email`,`password`,`roles`,`name`,`logins`,`last_login`,`login_attempts`,`banned_to`,`ban_time`,`reset_password_code`,`created_at`,`updated_at`,`register_token`,`active`,`username`) VALUES ( '2', 'v@mail.ru', '32c473f545fbbafd2c275b6ef518f2cccf14059b5ca6e1f00c2a7748528398b9', '1', 'v', '1', '1440585129', '0', NULL, NULL, NULL, '0', '1440585129', NULL, '1', '' );
-- ---------------------------------------------------------
