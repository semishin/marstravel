<form class="form-signin col-xs-5 col-xs-offset-3 col-md-6 col-md-offset-3 lightbox_form"  role="form">
    <h2 class="form-signin-heading lightbox_header">Введите ваши данные</h2>
    ...
    <button class="btn  red_btn" name="sign_in" type="submit">Войти</button>
</form>