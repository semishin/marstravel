...
class Form_Admin_Hotel extends CM_Form_Abstract
{
    protected function init()
    {
        ...
        $this->set_field('link_site', new CM_Field_String(), 10);
        $this->set_field('link_booking', new CM_Field_String(), 12);
        ...
        $fieldgroups = array(
            'Основные данные' => array('name', 'city_id', 'active', 'stars', 'main_image', 'images', 'url', 'link_site', 'link_booking', 'content'),
