...
class Model_Tour extends ORM
{
    ...
    public function labels()
    {
        return array(
            ...
            'name' => 'Наименование',
//            'cities' => 'Города',
            'price' => 'Стоимость для взрослого',
            'price_child' => 'Стоимость для ребенка',
            'slogan' => 'Слоган',
            'route' => 'Маршрут',
            ...
            'd1_image' => '1 день картинка',
            'd2_image' => '2 день картинка',
            'd3_image' => '3 день картинка',
            'd4_image' => '4 день картинка',
            'd5_image' => '5 день картинка',
            'd6_image' => '6 день картинка',
            'd7_image' => '7 день картинка',
            'd8_image' => '8 день картинка',
            's_title' => 'SEO title',
