...
INSERT INTO `sights`(`id`,`name`,`main_image`,`content`,`images`,`category_id`,`active`,`excursion`,`city_id`,`url`,`md5_url`,`s_description`,`s_title`,`s_keywords`) VALUES ( '4', 'тестовая достоприме', '/files/sight/4/32425b0aef2cfec1107fdc7d481179fd.jpg', '', '[]', '3', '1', '0', '1', 'testovaya-dostoprime', '880bcabad205cd4db3862cfe0ec08b62', '', '', '' );
