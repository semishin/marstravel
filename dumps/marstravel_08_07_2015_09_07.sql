...
CREATE TABLE `order` ( 
	...
	`number` Char( 32 ) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL, 
...
INSERT INTO `questions`(`id`,`name`,`email`,`phone`,`question`) VALUES ( '16', 'wdwqada', 'awda', 'awdad', 'awdawd' );
INSERT INTO `questions`(`id`,`name`,`email`,`phone`,`question`) VALUES ( '17', 'вфцв', 'ВЦФВ', 'ФВЦ', 'ФВЦФ' );
-- ---------------------------------------------------------
