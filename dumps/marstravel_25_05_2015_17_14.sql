...
-- Dump data of "cities" -----------------------------------
INSERT INTO `cities`(`id`,`name`,`active`) VALUES ( '1', 'Царьград', '1' );
INSERT INTO `cities`(`id`,`name`,`active`) VALUES ( '2', 'Константинополь', '1' );
-- ---------------------------------------------------------
...
' );
INSERT INTO `pages`(`id`,`name`,`s_title`,`s_description`,`s_keywords`,`url`,`active`,`updated_at`,`static`,`content`) VALUES ( '34', 'Наши партнеры', 'Наши партнеры - marstravel.local', '', '', 'our-partners', '1', '2015-05-18 11:19:16', '0', '' );
INSERT INTO `pages`(`id`,`name`,`s_title`,`s_description`,`s_keywords`,`url`,`active`,`updated_at`,`static`,`content`) VALUES ( '35', 'Отели Турции', 'Отели Турции - marstravel.local', '', '', 'hotels', '1', '2015-05-18 12:43:29', '0', '' );
...
INSERT INTO `pages`(`id`,`name`,`s_title`,`s_description`,`s_keywords`,`url`,`active`,`updated_at`,`static`,`content`) VALUES ( '38', 'Достопримечательности', 'Достопримечательности - marstravel.local', '', '', 'sight', '1', '2015-05-18 12:44:38', '0', '' );
INSERT INTO `pages`(`id`,`name`,`s_title`,`s_description`,`s_keywords`,`url`,`active`,`updated_at`,`static`,`content`) VALUES ( '39', 'Реклама на сайте', 'Реклама на сайте - marstravel.local', '', '', 'advertising', '1', '2015-05-18 12:48:37', '0', '' );
-- ---------------------------------------------------------
...
INSERT INTO `tours`(`id`,`name`,`active`,`content`,`url`,`md5_url`,`s_description`,`s_keywords`,`s_title`,`position`,`images`,`price`,`main_image`,`short_content`,`d1_name`,`d2_name`,`d3_name`,`d4_name`,`d5_name`,`d6_name`,`d7_name`,`d8_name`,`d1_content`,`d2_content`,`d3_content`,`d4_content`,`d5_content`,`d6_content`,`d7_content`,`d8_content`,`included`,`excluded`,`slogan`) VALUES ( '56', 'Тур «Наследие великих цивилизаций» 2', '1', '<p>8-дневный тур &laquo;Наследие великих цивилизаций&raquo;. Вы проведете несколько дней в Стамбуле, который по праву причисляют к мировым культурным столицам. Из Стамбула Ваш маршрут будет пролегать через воспетую Гомером Трою, античный Пергам, современный портовый город Кушадасы и далее через живописные Таврские горы в бурлящую энергией Анталию с ее фантастическим побережьем</p>
...
INSERT INTO `tours`(`id`,`name`,`active`,`content`,`url`,`md5_url`,`s_description`,`s_keywords`,`s_title`,`position`,`images`,`price`,`main_image`,`short_content`,`d1_name`,`d2_name`,`d3_name`,`d4_name`,`d5_name`,`d6_name`,`d7_name`,`d8_name`,`d1_content`,`d2_content`,`d3_content`,`d4_content`,`d5_content`,`d6_content`,`d7_content`,`d8_content`,`included`,`excluded`,`slogan`) VALUES ( '57', 'Тур «Наследие великих цивилизаций» 3', '1', '<p>8-дневный тур &laquo;Наследие великих цивилизаций&raquo;. Вы проведете несколько дней в Стамбуле, который по праву причисляют к мировым культурным столицам. Из Стамбула Ваш маршрут будет пролегать через воспетую Гомером Трою, античный Пергам, современный портовый город Кушадасы и далее через живописные Таврские горы в бурлящую энергией Анталию с ее фантастическим побережьем</p>
...
-- Dump data of "sights" -----------------------------------
INSERT INTO `sights`(`id`,`name`,`main_image`,`content`,`images`,`category_id`,`active`,`excursion`,`city_id`,`url`,`md5_url`,`s_description`,`s_title`,`s_keywords`) VALUES ( '1', 'Тестовая достопримечательность', '/files/sight/1/384f3a9cf3ae257aacaf4683d16a10f3.jpg', '<p>описание тестовой достопримечательности</p>
