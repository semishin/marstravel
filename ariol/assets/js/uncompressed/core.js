...
jQuery(document).ready(function($){
	...
	$('#main-menu-min').click(function(){
		...
		if($(this).hasClass('full')){
			...
			$('#id_content').addClass('sidebar-minified');
			...
			$('#id_content').removeClass('sidebar-minified');
...
function widthFunctions(e) {
	...
	var contentHeight = $('#id_content').height();
	var contentHeightOuter = $('#id_content').outerHeight();
	...
	if (winWidth > 767) {
		...
		if (winHeight - 80 > contentHeight) {
			$('#id_content').css('min-height',winHeight-headerHeight-footerHeight-30);
		}
