...
<div class="change" id="changed-field">
    <?php echo form::select_improved($name, $options, $value, $attributes);?>
</div>
...
<script type="text/javascript">
	...
	oldFieldStringValue : $('#changed-field').children('select').val(),
	oldFieldSelectValue : $('#changed-field').children('select').val(),
	value : "",
